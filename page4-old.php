...
require("header.php");
?>
<div id="mainPanel" class="parallax page4">
    <div class="container-12">
    	
        <h1><span>Welcome back, [John Figa]!</span> <br/>
        <span>Our records indicate that we have your record on file.
Click below to submit for a $100 - $10,000 Installment Loan
from our National Lenders Database.</span></h1>
        <ul>
        ...
        <div class="clear"></div>  
        <div id="fields">
				<form id="page4Form" method="post" action="/gateway-1/" novalidate="novalidate">
