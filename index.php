...
<div id="mainPanel" class="parallax v1">
    <div class="container-12">
        ...
        <div class="fieldElement alpha selecter" id="amountField"> <span class="icon"></span> <span class="validateField">
        ...
        <div class="fieldElement" id="email"> <span class="icon"></span> <span class="validateField">
          <input type="email" name="email" placeholder="Email Address" value="">
          <span class="validateIcon"></span> </span> </div>
        <div class="fieldElement" id="ssnField"> <span class="icon"></span> <span class="validateField">
          <input class="js-digit-only" type="text" name="ssn" minlength="4" maxlength="4" placeholder="Last 4 of SSN#" value="">
          <span class="validateIcon"></span> </span> </div>
        <div class="fieldElement selecter omega" id="byField"> <span class="icon"></span> <span class="validateField">
          <div class="customSelect">
            <select name="dob" class="select_small_4">
        ...
        <div class="fieldElement" id="zipField"> <span class="icon"></span> <span class="validateField">
          <input class="js-digit-only" type="text" name="zip" placeholder="Zip" minlength="5" maxlength="5" value="">
           </span> </div>
