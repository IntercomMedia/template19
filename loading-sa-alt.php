...
<head>
    ...
    <![endif]-->
        ...
        <body class="loadingPage">
            ...
            <div style="text-align: center;padding: 20px; overflow: hidden;color:#fff; background: #333;">
                    <h1 style="color:#fff;">Requesting your loan approval...</h1>
                    <p>Please wait while we are locating a lender that matches your needs.</p>
					<div class="inner">
						<div id="percentBar" style="height: 60px; width: 100%; max-width: 400px; background: rgba(255,255,255,.4); margin: 20px auto; position: relative;">
							<p id="percentText2" style="position: absolute;
					width: 100%;
					text-align: center;
					line-height: 60px;
					font-size: 2.307em;
					z-index: 900; color: #fff;margin: 0;">Processing...</p>
							<div id="progressBar" style="width: 0; height: 60px; background: green; position: absolute; top: 0;"></div>
						</div>
            </div>
            </div>
            <div style="text-align: center;">
            <p>This process can take several minutes</p>
				<h2 id="percentText" style="position: absolute;
			width: 100%;
			text-align: center;
			line-height: 60px;
			font-size: 2.307em;
			z-index: 900;margin: 0;"></h2>
			</div>
