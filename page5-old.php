    	...
    	<div class="container-12">
    		<div class="grid-9">
    			<div class="inner">
					...
					<h1>Lenders are currently online and accepting requests!</h1>
					<p>Open <strong>24/7</strong>: <span class="date" id="date_time"></span></p>
...
<div id="" class="prominent parallax page5">
    <div class="container-12">
        <div class="grid-6">
        	<h1>Final Step</h1>
        	<p class="largeFont">Our records indicate that we have your record on file.
Click below to submit for a $100 - $1,000 Cash Loan.</p>
				<form id="page5Form" method="post" action="/gateway-1/" novalidate="novalidate">
					...
					<div class="fieldElement" id="emailField">
						<span class="validateField">
							<input type="text" name="email" id="ssn" placeholder="Eamil Address" value="">
						</span>
					</div>
					...
					<div class="fieldElement selecter" id="byField">
							<span class="validateField">
								<div class="customSelect">
									<select name="dobY" class="" value="">
	...
	<div class="featurette">
		<ul>
			<li class="safe"><i class="fa fa-lock"></i>Safe and secure</li>
			<li class="fast"><i class="fa fa-money"></i>Fast cash delivery</li>
			<li class="approval"><i class="fa fa-clock-o"></i>Quick approval</li>
			<li class="affordable"><i class="fa fa-check-circle"></i>Affordable loans</li>
		</ul>
	</div>    
</div>
